...
<div class="overlay">
  <div id="navbar">
      ...
      <?php if(empty($_SESSION['id_user']) && empty($_SESSION['id_company'])) { ?>
            ...
            <a href="register_candidate.php">User Join</a>  
       ...
       <h1>All in One Job Portal</h1>
        ...
        <p><br>Link with the Worlds leading Job portal,by Joining us! <br>
          Over 1,50,000 users got their dream jobs.</p>
