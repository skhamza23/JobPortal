	...
	<div id="wrapper">
		<div id="sidebar-nav" class="sidebar">
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
					<li><a href="dashboard_candidate.php" class=""><i class="lnr lnr-home"></i> <span>Dashboard</span></a></li>
          ...
          */
          ...
          if($result->num_rows > 0) {
			...
			<div class="thumbnail ">
				...
				<img src="uploads/logo/<?php echo $row1['logo']; ?>" alt="Attachment Image">
			<!-- <img src="C:\xampp\htdocs\job\uploads\logo\apple.jpg>"  width=50px height=10vh> -->
				<div class="caption">
				<a> <?php echo $row['jobtitle']; ?></a>
            <p class="flex-text text-muted"><br><?php echo $row['description']; ?> <br>Salary: $<?php echo $row['maximumsalary']; ?>/Month</span></h4>
                  <br>  <?php echo $row1['companyname']; ?> <br> <?php echo $row1['city']; ?> <br>Experience: <?php echo $row['experience']; ?> Years
				</p>
					<p>
						<a class="btn btn-danger" href="view-job-post1.php?id=<?php echo $row['id_jobpost']; ?>">Link</a>
					</p>
				</div>
				<!-- /.caption -->
			</div>
