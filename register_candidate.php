...
<div class="wrapper">
   ...
   <section class="content-header">
      <div class="container">
        <div class="row latest-job margin-top-50 margin-bottom-20 bg-white">
          ...
          <form method="post" id="registerCompanies" action="addcandidate.php" enctype="multipart/form-data">
            <div class="col-md-6 latest-job ">
              ...
              <div class="form-group">
                <input class="form-control input-sm" type="text" name="age" placeholder="Age">
              </div>
              <div class="form-group">
                <input class="form-control input-sm" type="text" name="qualification" placeholder="Qualification">
              </div>
              <div class="form-group">
                <input class="form-control input-sm" type="text" name="stream" placeholder="Stream">
              </div>
              <div class="form-group">
                <textarea class="form-control input-sm" rows="4" name="aboutme" placeholder="Brief info about yourself"></textarea>
              </div>
            ...
            <div class="col-md-6 latest-job ">
              ...
              <div class="form-group">
                <input class="form-control input-sm" type="text" name="city" placeholder="Select City" required>
              </div>
  ...
  <footer class="main-footer" style="margin-left: 0px;">
    <div class="text-center">
      <strong>Copyright &copy; 2023 <a href="learningfromscratch.online">Job Portal</a>.</strong> All rights
    reserved.
    </div>
  </footer>
