	...
	<div id="wrapper">
		<div id="sidebar-nav" class="sidebar">
			<div class="sidebar-scroll">
				<nav>
        <ul class="nav">
						<li><a href="dashboard_company.php" class=""><i class="lnr lnr-home"></i> <span>Dashboard</span></a></li>
            ...
            <li><a href="create-job-post.php" class=""><i class="lnr lnr-calendar-full"></i></span>Create Job</span></a></li>
						...
						<li><a href="resume-database.php" class=""><i class="lnr lnr-user"></i> Resumes</a></li>
						<li><a href="company-settings.php" class="active"><i class="lnr lnr-cog"></i> Settings</a></li>
